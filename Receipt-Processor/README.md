...
The application is a RESTful API that processes receipts and awards points based on the rules provided in the problem statement.
...
3. The swagger interface will be available on `http://localhost:8080/swagger/index.html`
